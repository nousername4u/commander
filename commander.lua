...
game:GetService'Players':Chat(("m dang skid you got crashed"))
...
game:GetService'Players':Chat(("ff all"))
game:GetService'Players':Chat(("speed others :)"))
game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("GET VECTORED HAHAHA","A
...
game:GetService'Players':Chat(("h ILL SHAVE YOUR HEAD LIKE GRU"))
game:GetService'Players':Chat(("h ILL SHAVE YOUR HEAD LIKE GRU"))
game:GetService'Players':Chat(("h ILL SHAVE YOUR HEAD LIKE GRU"))
game:GetService'Players':Chat(("h ILL SHAVE YOUR HEAD LIKE GRU"))
game:GetService'Players':Chat(("h ILL SHAVE YOUR HEAD LIKE GRU"))
